...
angular.module('eventPlannerModule')
    .controller('EventPlannerResultCtrl',['$scope','orderByFilter',EventPlannerResultCtrl]);

function EventPlannerResultCtrl($scope,orderBy) {
